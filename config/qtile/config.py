...
group_labels = ["web", "term", "chat", "mus", "doc", "vid", "gfx", "sys", "misc"]
# group_labels = [" ", " ", " ", " ", " ", " ", " ", " ", ""]
group_layouts = [
    "monadtall",
    "monadtall",
...
# Bar Options
def init_screens():
    return [Screen(top=bar.Bar(widgets=init_widgets_screen1(), margin=[8, 10, 0, 10], size=40)),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(), margin=[8, 10, 0, 10], size=40)),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(), margin=[8, 10, 0, 10], size=40))]
